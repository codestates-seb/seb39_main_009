...
sudo ln -s /home/ubuntu/.nvm/versions/node/v18.9.1/bin/node /usr/bin/node
sudo ln -s /home/ubuntu/.nvm/versions/node/v18.9.1/bin/npm /usr/bin/npm
sudo nohup /home/ubuntu/.nvm/versions/node/v18.9.1/bin/serve -s /$BUILD_FRONT/build/ >> /home/ubuntu/deployFe.log 2> /home/ubuntu/action/deploy_err.log &
