...
class ReviewControllerTest {
    ...
    void set() {
        ...
        ReviewResDto reviewResDto = new ReviewResDto(1L, 1L, 1.0, review1.getMember().getNickname(), review1.getBody(), LocalDateTime.now(), LocalDateTime.now());
    ...
    public void viewReviews() throws Exception {
        ...
        ReviewResDto reviewResDto1 = new ReviewResDto(1L, 1L, 1.0,"nickname1", "body1", LocalDateTime.now(), LocalDateTime.now());
